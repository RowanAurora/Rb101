=begin
PROBLEM: Write a method that takes a positive integer as an argument and returns that number with its digits reversed. Examples:
...
ALGORITHM:
Take Input argument and convert to string.
Reverse string
