...
longest sentence in the file based on number of words. Sentences may end with periods 
(.), exclamation points (!), or question marks (?). Any sequence of characters that are 
not spaces or sentence-ending characters should be treated as a word. You should also print 
the number of words in the longest sentence.

Input: string
Output: number representing the most words in a sentence in the string

ie 86

algorithm

Split string into array based on sentences

Iterate though mapping the size of the sentences
...
text = %{Project Gutenberg's Frankenstein, by Mary Wollstonecraft (Godwin) Shelley
